...
## Reducing Eye Movement (Collocating Simple Logic)
...
const checkIsNameValid: ValidationResult = (name: string) => {
...
const checkIsAgeValid: ValidationResult = (age: number) => {
...
const fetchBalance: Promise<number> = async () => {
